...
(define
 (problem box-p10)
  ...
  (:init (= (total-cost) 0) (box-at-city box0 city3)
         ...
         (box-at-city box4 city10)
         (destination box4 city7)
         (box-at-city box5 city5)
         (destination box5 city8)
         (box-at-city box6 city11)
         (destination box6 city1)
         (box-at-city box7 city8)
         (destination box7 city13)
         (box-at-city box8 city2)
         (destination box8 city6)
         (box-at-city box9 city5)
         (destination box9 city3)
         (box-at-city box10 city12)
         (destination box10 city2)
         (box-at-city box11 city7)
         (destination box11 city11)
         (box-at-city box12 city12)
         (destination box12 city13)
         (box-at-city box13 city13)
         (destination box13 city5)
         (box-at-city box14 city5)
         (destination box14 city9)
         ...
         (wrong-drive3 city9 city12)
         (can-drive city10 city6)
         (can-drive city10 city13)
         (can-drive city10 city12)
         (wrong-drive1 city10 city6)
         (wrong-drive2 city10 city13)
         (wrong-drive3 city10 city12)
         (can-drive city11 city2)
         (can-drive city11 city7)
         (can-drive city11 city4)
         (wrong-drive1 city11 city2)
         (wrong-drive2 city11 city7)
         (wrong-drive3 city11 city4)
         (can-drive city12 city5)
         (can-drive city12 city6)
         (can-drive city12 city9)
         (can-drive city12 city10)
         (can-drive city12 city13)
         (wrong-drive1 city12 city5)
         (wrong-drive2 city12 city6)
         (wrong-drive3 city12 city9)
         (can-drive city13 city2)
         (can-drive city13 city5)
         (can-drive city13 city6)
         (can-drive city13 city10)
         (can-drive city13 city12)
         (wrong-drive1 city13 city2)
         (wrong-drive2 city13 city5)
         (wrong-drive3 city13 city6)
         (can-drive city14 city0)
         (can-drive city14 city3)
         (can-drive city14 city4)
         (can-drive city14 city8)
         (wrong-drive1 city14 city0)
         (wrong-drive2 city14 city3)
         (wrong-drive3 city14 city4)
  )
  (:goal (and
      ...
      (box-at-city box4 city7)
      (box-at-city box5 city8)
      (box-at-city box6 city1)
      (box-at-city box7 city13)
      (box-at-city box8 city6)
      (box-at-city box9 city3)
      (box-at-city box10 city2)
      (box-at-city box11 city11)
      (box-at-city box12 city13)
