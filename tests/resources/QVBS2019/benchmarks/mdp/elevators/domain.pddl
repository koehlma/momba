(define (domain elevators)
  (:requirements :probabilistic-effects :negative-preconditions :equality :typing)
  ...
  (:action move-left-gate
    ...
    :effect (and (increase (total-cost) 1) (probabilistic 1/2 (and (not (at ?f ?p)) (at ?f ?np))
                           1/2 (and (not (at ?f ?p)) (at f1 p1))))
  )
  (:action move-right
    :parameters (?f - floor ?p ?np - pos)
